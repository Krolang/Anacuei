...
Link to source : https://github.com/JVital2013/pihole-router/blob/main/README.md

>[!NOTE]
>I used this to guide me in the setup process that was needed to install Pi-Hole. It was used as a last resort. There are many things in this guide you don't need to do. If you wish to implement any of the features described in this guide, by all means do so. I was just happy to get mine working.
...
**3.**  Turn off the Wi-Fi broadcast on your modem (if any)
...
>[!WARNING]
>This is where I stopped, as I was connecting to the modem via a Wi-Fi mesh. This step may be necessary, but check to see if everything works first to save some trouble.
